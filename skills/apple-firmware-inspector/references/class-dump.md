...
```bash
ipsw class-dump "$OLDER_DSC" UIKit --class UITableView > "UITableView_$OLDER_IOS_VERSION.h"
ipsw class-dump "$NEWER_DSC" UIKit --class UITableView > "UITableView_$NEWER_IOS_VERSION.h"
diff "UITableView_$OLDER_IOS_VERSION.h" "UITableView_$NEWER_IOS_VERSION.h"
```
