...
- Keep Codex `interface.websiteURL`, `homepage`, and `repository` pointed at
  this standalone public source. Do not make another repository a public
  dependency, catalog landing page, or support destination.
